# File to enter manually executing this script, without calling the api
...
from utils.config import url, download_dir, page_max_timeout
...
# The driver must have accessed the web
